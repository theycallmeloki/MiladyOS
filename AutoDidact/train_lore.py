"""nano-milady lore GRPO training (container edition).

1B student, agentic search over the lore corpus, wandb-tracked.
Run inside the rl_training image; data + patched modules are mounted in.
"""
